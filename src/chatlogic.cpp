...
ChatLogic::ChatLogic() {
  ...
  // pass pointer to chatlogic to chatbot so that chatbot answers can be passed
  // on to the GUI
        ...
        if (idToken != tokens.end()) {
          ...
          if (type->second == "EDGE") {
            ...
            if (parentToken != tokens.end() && childToken != tokens.end()) {
              ...
              // create new edge with smart pointer
